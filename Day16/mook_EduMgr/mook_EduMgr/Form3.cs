...
namespace mook_EduMgr
{
    public partial class Form3 : Form
    {
        ...
        private void Form3_Load(object sender, EventArgs e)
        {
            ...
            var Comm = new SqlCommand("Select name, edunum, birth, email, phone from t_userinfo where edunum = '" + EduNum + "'", Conn);
        ...
        private void btnModify_Click(object sender, EventArgs e)
        {
            ...
            var Conn = new SqlConnection(Constr);
            Conn.Open();
            var strSQL = "update t_userinfo set birth = '" + this.txtBirth.Text + "', email = '" +
                this.txtEmail.Text + "', phone = '" + this.txtPhone.Text + "' where edunum = " + EduNum + "";
